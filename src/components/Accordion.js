...
export default function Accordion({ title, answer }) {
  ...
  return (
    <div className="w-full h-full py-2 border-b-2 border-solid border-[#ffd35b8e] bg-black px-1 decoration-0">
      <button
        onClick={() => setAccordionOpen(!accordionOpen)}
        className="flex justify-between items-center w-full p-1 px-3"
      >
      ...
      >
        <div className="overflow-hidden mt-1 px-4 decoration-0 main-font text-white">
          {answer}
        </div>
      </div>
    </div>
