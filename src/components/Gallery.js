      ...
      <div className={styles["horizontal-scroll-wrapper"]}>
        ...
        <div className={`${styles["img-wrapper"]} ${styles.faster}`}>
          ...
          <Image
            ...
            width={1500}
            height={1000}
            alt="E-Summit Gallery Image 2"
          />
        </div>

        <div
          className={`${styles["img-wrapper"]} ${styles.slower} ${styles.vertical}`}
        >
          ...
          <Image
            ...
            width={1500}
            height={1000}
            alt="E-Summit Gallery Image 3"
          />
        </div>

        <div
          className={`${styles["img-wrapper"]} ${styles.slower} ${styles["slower-down"]}`}
        >
        ...
        <div className={`${styles["img-wrapper"]} ${styles.faster1}`}>
          ...
          <Image
            ...
            width={1500}
            height={1000}
            alt="E-Summit Gallery Image 7"
          />
        </div>

        <div
          className={`${styles["img-wrapper"]} ${styles.slower} ${styles.slower2}`}
        >
        ...
        <div className={`${styles["img-wrapper"]} ${styles.slower}`}>
          ...
          <Image
            ...
            width={1500}
            height={1000}
            alt="E-Summit Gallery Image 10"
          />
        </div>

        <div
          className={`${styles["img-wrapper"]} ${styles.slower} ${styles.last}`}
        >
